...
public final class ValidacionErroresTest {
    ...
    public void testIsError_ReturnError() throws Exception {
        ValidacionErrores validacionErrores = ((ValidacionErrores) createInstance("com.imss.sivimss.formatopagare.util.ValidacionErrores"));
        setField(validacionErrores, "com.imss.sivimss.formatopagare.util.ValidacionErrores", "error", false);
